...
export const projects = [
	...
	},
	{
		...
		slug: 'rainydays',
		description:
			'A fictional site for an outdoor jacket seller, using a headless WordPress CMS for content.',
		content: [
	...
	},
	{
		...
		description:
			'A website for a community science museum, as part of a first-semester project for Noroff.',
		content: [
