    ...
    <div class="max-w-screen-xl mx-auto">
      ...
      <div class="mx-auto mb-5 w-fit">
        ...
        <ul class="items-center w-full rounded-lg border border-primary smd:flex dark:bg-light-primary dark:border-primary divide-x divide-primary dark:divide-primary">
          <li class="w-full"><Radio name="hor-list" bind:group={filter} color="purple" value="All" class="p-1 smd:p-3 dark:!text-gray-900 cursor-pointer">All</Radio></li>
          <li class="w-full"><Radio name="hor-list" bind:group={filter} color="purple" value="Svelte" class="p-1 smd:p-3  dark:!text-gray-900 cursor-pointer">Svelte/TypeScript</Radio></li>
          <li class="w-full"><Radio name="hor-list" bind:group={filter} color="purple" value="React" class="p-1 smd:p-3 dark:!text-gray-900 cursor-pointer">React</Radio></li>
          <li class="w-full"><Radio name="hor-list" bind:group={filter} color="purple" value="JavaScript" class="p-1 smd:p-3 dark:!text-gray-900 cursor-pointer">JavaScript</Radio></li>
